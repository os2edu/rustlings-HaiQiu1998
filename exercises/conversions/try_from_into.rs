...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        // if let Ok(a) = try_from(tuple.0){
        //     if let Ok(b) = try_from(tuple.1){
        //         if let Ok(c) = try_from(tuple.2){
        //             return Ok(Self{red: a,
        //                 green: b,
        //                 blue: c,})
        //         }
        //     }
        ...
        return Ok(Self{red: tuple.0 as u8,
            green: tuple.1 as u8,
            blue: tuple.2 as u8,});
    }
}
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        ...
        return Ok(Self{red: arr[0] as u8,
            green: arr[1] as u8,
            blue: arr[2] as u8,});
    }
}
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        ...
        return Ok(Self{red:slice[0] as u8,
            green: slice[1] as u8,
            blue: slice[2] as u8,});
    }
}
